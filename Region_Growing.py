...
class Stack():
    def __init__(self):  # Perbaikan: Gunakan __init__ dengan dua garis bawah
        self.item = []
...
class regionGrow():
    def __init__(self, im_path, th):  # Perbaikan: Gunakan __init__ dengan dua garis bawah
...
# Gunakan kelas regionGrow
im_path = "face-image.jpg"
threshold = 20
region_grow = regionGrow(im_path, threshold)
region_grow.ApplyRegionGrow()
